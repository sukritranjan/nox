...
logK4=222.3
logK8=160.8
logK12=162.1  #corrected for aqueous dG
...
for j in np.arange(len(Harr)):
    ...
    def equations(p):
        ...
        #WITH LOGS
        logNO3,logNO2,logNO,logN2O,logN2,logNH4 = p    #in concentration
        #Uncomment below if solving full system with explicit pKas
        #logNO3,logNO2,logNO,logN2O,logN2,logNH4,logHNO3,logHNO2,logNH3 = p
        ...
        #Uncomment below if solving full system with explicit pKas
        #fA=logH+logNO3-logHNO3-logKaHNO3
        #fB=logH+logNO2-logNH4-logKaHNO2
        #fC=logH+logNH3-logNH4-logKaNH4
        
        fX=V*(10.**logNH4 + 10.**(logKaNH4 + logNH4 - logH) + 2.*10.**logN2 + 2.*10.**logN2O + 10.**logNO + 10.**logNO2 + 10.**logNO3 + 10.**(logH + logNO2 - logKaHNO2) + 10.**(logH + logNO3 - logKaHNO3)) + (((10.**logNH3)/H_NH3 + (2.*10.**logN2)/H_N2 + (2.*10.**logN2O)/H_N2O + (10.**logNO)/H_NO + (10.**logHNO2)/H_HNO2 + (10.**logHNO3)/H_HNO3 )*1.0E5*4*3.14159*(6.37E6)**2./(28.*1.67E-27*9.8))/6.02E23 - n
        #Uncomment below if solving full system with explicit pKas instead of above
        #fX=V*(10.**logNH4 + 10.**logNH3 + 2.*10.**logN2 + 2.*10.**logN2O + 10.**logNO + 10.**logNO2 + 10.**logNO3 + 10.**logHNO2 + 10.**logHNO3) + (((10.**logNH3)/H_NH3 + (2.*10.**logN2)/H_N2 + (2.*10.**logN2O)/H_N2O + (10.**logNO)/H_NO + (10.**logHNO2)/H_HNO2 + (10.**logHNO3)/H_HNO3 )*1.0E5*4*3.14159*(6.37E6)**2./(28.*1.67E-27*9.8))/6.02E23 - n
        
        return (f4,f8,f12,f14,f15,fX)
    #Uncomment below if solving full system with explicit pKas instead of above
    #return (f4,f8,f12,f14,f15,fA,fB,fC,fX)
    
    
    logNO3,logNO2,logNO,logN2O,logN2,logNH4=fsolve(equations, (-10,-10,-10,-10,-10,-1.05),xtol=1.0E-3)
    #Uncomment below if solving full system with pKa equations explicitly (instead of above)
    #logNO3,logNO2,logNO,logN2O,logN2,logNH4,logHNO3,logHNO2,logNH3=fsolve(equations, (-10,-10,-10,-10,-10,-1,-10,-10,-1),xtol=1.0E-3)
    ...
    N2=10.**logN2
    NH4=10.**logNH4
    #UNCOMMENT BELOW IF SOLVING pKa EQUATIONS EXPLICITLY
    #HNO3=10.**logHNO3
    #HNO2=10.**logHNO2
    #NH3=10.**logNH3
    
    #print(NO3,NO2,NO,N2O,N2,NH4,HNO3,HNO2,NH3)
    print(NO3,NO2,NO,N2O,N2,NH4)
...
molesPHNO3_0=PHNO3_0*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPHNO2_0=PHNO2_0*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPNO_0=PNO_0*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPN2O_0=PN2O_0*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPN2_0=PN2_0*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPNH3_0=PNH3_0*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole

molesNO3_0=NO3_0*V/totmole
molesNO2_0=NO2_0*V/totmole
molesNO_0=NO_0*V/totmole
molesN2O_0=N2O_0*V/totmole
molesN2_0=N2_0*V/totmole
...
pH_n10=np.array([4,6,8,10,12])

NO3_n10=np.array([9.6158503267707134e-85,1.3208344400920045e-82,3.2124456601730433e-87,1.239458056863841e-78,1.3294292008158695e-76])
NO2_n10=np.array([5.4073900161760857e-64,7.4275978878963919e-62,1.8064910060576626e-66,7.4766914114832709e-58,7.4761509036144849e-56])
NO_n10=np.array([6.2147006885024857e-54,1.6875359226639214e-53,0.0,2.6559524429894738e-53,2.6526381346167462e-53])
N2O_n10=np.array([1.2213508362793381e-56,9.0054631385455993e-56,0.0,2.2236191616555032e-55,2.2251337419661358e-55])
N2_n10=np.array([0.00018449108717403793,0.00034809418496648616,0.00046885618292080142,0.00035265903919009031,0.00035265993055390912])
NH4_n10=np.array([0.069730088604870399,0.0018934464475166093,5.5219039908652594e-291,2.9763055210979087e-07,2.9763092825034395e-09])
...
molesPHNO3_n10=PHNO3_n10*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPHNO2_n10=PHNO2_n10*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPNO_n10=PNO_n10*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPN2O_n10=PN2O_n10*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPN2_n10=PN2_n10*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPNH3_n10=PNH3_n10*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole

molesNO3_n10=NO3_n10*V/totmole
molesNO2_n10=NO2_n10*V/totmole
molesNO_n10=NO_n10*V/totmole
molesN2O_n10=N2O_n10*V/totmole
molesN2_n10=N2_n10*V/totmole
...
molesPHNO3_n20=PHNO3_n20*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPHNO2_n20=PHNO2_n20*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPNO_n20=PNO_n20*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPN2O_n20=PN2O_n20*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPN2_n20=PN2_n20*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPNH3_n20=PNH3_n20*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole

molesNO3_n20=NO3_n20*V/totmole
molesNO2_n20=NO2_n20*V/totmole
molesNO_n20=NO_n20*V/totmole
molesN2O_n20=N2O_n20*V/totmole
molesN2_n20=N2_n20*V/totmole
...
molesPHNO3_n30=PHNO3_n30*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPHNO2_n30=PHNO2_n30*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPNO_n30=PNO_n30*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPN2O_n30=PN2O_n30*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPN2_n30=PN2_n30*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPNH3_n30=PNH3_n30*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole

molesNO3_n30=NO3_n30*V/totmole
molesNO2_n30=NO2_n30*V/totmole
molesNO_n30=NO_n30*V/totmole
molesN2O_n30=N2O_n30*V/totmole
molesN2_n30=N2_n30*V/totmole
...
molesPHNO3_n40=PHNO3_n40*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPHNO2_n40=PHNO2_n40*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPNO_n40=PNO_n40*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPN2O_n40=PN2O_n40*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPN2_n40=PN2_n40*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPNH3_n40=PNH3_n40*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole

molesNO3_n40=NO3_n40*V/totmole
molesNO2_n40=NO2_n40*V/totmole
molesNO_n40=NO_n40*V/totmole
molesN2O_n40=N2O_n40*V/totmole
molesN2_n40=N2_n40*V/totmole
...
molesPHNO3_n50=PHNO3_n50*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPHNO2_n50=PHNO2_n50*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPNO_n50=PNO_n50*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPN2O_n50=PN2O_n50*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPN2_n50=PN2_n50*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPNH3_n50=PNH3_n50*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole

molesNO3_n50=NO3_n50*V/totmole
molesNO2_n50=NO2_n50*V/totmole
molesNO_n50=NO_n50*V/totmole
molesN2O_n50=N2O_n50*V/totmole
molesN2_n50=N2_n50*V/totmole
...
molesPHNO3_n60=PHNO3_n60*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPHNO2_n60=PHNO2_n60*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPNO_n60=PNO_n60*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPN2O_n60=PN2O_n60*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPN2_n60=PN2_n60*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPNH3_n60=PNH3_n60*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole

molesNO3_n60=NO3_n60*V/totmole
molesNO2_n60=NO2_n60*V/totmole
molesNO_n60=NO_n60*V/totmole
molesN2O_n60=N2O_n60*V/totmole
molesN2_n60=N2_n60*V/totmole
...
HNO3_n80=(H_n10*NO3_n80)/(10.**logKaHNO3)
HNO2_n80=(H_n10*NO2_n80)/(10.**logKaHNO2)
...
molesPHNO3_n80=PHNO3_n80*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPHNO2_n80=PHNO2_n80*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPNO_n80=PNO_n80*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPN2O_n80=PN2O_n80*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPN2_n80=PN2_n80*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole
molesPNH3_n80=PNH3_n80*4.*3.14159*Rearth**2.0/(mu*mH*g*Na)/totmole

molesNO3_n80=NO3_n80*V/totmole
molesNO2_n80=NO2_n80*V/totmole
molesNO_n80=NO_n80*V/totmole
molesN2O_n80=N2O_n80*V/totmole
molesN2_n80=N2_n80*V/totmole
...
plt.bar(pH_0-.8,molesPHNO3_0,width,color='royalblue',label='HNO$_3$ (g)',alpha=.4,hatch='/',bottom=molesNO3_0+molesHNO3_0)
...
#H2=1E-20
plt.bar(pH_n20-.6,molesNO3_n20,width,color='royalblue',alpha=.8)
plt.bar(pH_n20-.6,molesHNO3_n20,width,color='royalblue',alpha=.4,bottom=molesNO3_n20)
plt.bar(pH_n20-.6,molesPHNO3_n20,width,color='royalblue',alpha=.4,hatch='/',bottom=molesNO3_n20+molesHNO3_n20)
plt.bar(pH_n20-.6,molesNO2_n20,width,color='mediumseagreen',alpha=.8,bottom=molesNO3_n20+molesHNO3_n20+molesPHNO3_n20)
plt.bar(pH_n20-.6,molesHNO2_n20,width,color='mediumseagreen',alpha=.4,bottom=molesNO3_n20+molesHNO3_n20+molesPHNO3_n20+molesNO2_n20)
plt.bar(pH_n20-.6,molesPHNO2_n20,width,color='mediumseagreen',alpha=.4,hatch='/',bottom=molesNO3_n20+molesHNO3_n20+molesPHNO3_n20+molesNO2_n20+molesHNO2_n20)
plt.bar(pH_n20-.6,molesNO_n20,width,color='gold',alpha=.4,bottom=molesNO3_n20+molesHNO3_n20+molesPHNO3_n20+molesNO2_n20+molesHNO2_n20+molesPHNO2_n20)
plt.bar(pH_n20-.6,molesPNO_n20,width,color='gold',alpha=.4,hatch='/',bottom=molesNO3_n20+molesHNO3_n20+molesPHNO3_n20+molesNO2_n20+molesHNO2_n20+molesPHNO2_n20+molesNO_n20)
plt.bar(pH_n20-.6,molesN2O_n20,width,color='aqua',alpha=.4,bottom=molesNO3_n20+molesHNO3_n20+molesPHNO3_n20+molesNO2_n20+molesHNO2_n20+molesPHNO2_n20+molesNO_n20+molesPNO_n20)
plt.bar(pH_n20-.6,molesPN2O_n20,width,color='aqua',alpha=.4,hatch='/',bottom=molesNO3_n20+molesHNO3_n20+molesPHNO3_n20+molesNO2_n20+molesHNO2_n20+molesPHNO2_n20+molesNO_n20+molesPNO_n20+molesN2O_n20)
plt.bar(pH_n20-.6,molesN2_n20,width,color='darkviolet',alpha=.4,bottom=molesNO3_n20+molesHNO3_n20+molesPHNO3_n20+molesNO2_n20+molesHNO2_n20+molesPHNO2_n20+molesNO_n20+molesPNO_n20+molesN2O_n20+molesPN2O_n20)
plt.bar(pH_n20-.6,molesPN2_n20,width,color='darkviolet',alpha=.4,hatch='/',bottom=molesNO3_n20+molesHNO3_n20+molesPHNO3_n20+molesNO2_n20+molesHNO2_n20+molesPHNO2_n20+molesNO_n20+molesPNO_n20+molesN2O_n20+molesPN2O_n20+molesN2_n20)
plt.bar(pH_n20-.6,molesNH4_n20,width,color='crimson',alpha=.8,bottom=molesNO3_n20+molesHNO3_n20+molesPHNO3_n20+molesNO2_n20+molesHNO2_n20+molesPHNO2_n20+molesNO_n20+molesPNO_n20+molesN2O_n20+molesPN2O_n20+molesN2_n20+molesPN2_n20)
plt.bar(pH_n20-.6,molesNH3_n20,width,color='crimson',alpha=.4,bottom=molesNO3_n20+molesHNO3_n20+molesPHNO3_n20+molesNO2_n20+molesHNO2_n20+molesPHNO2_n20+molesNO_n20+molesPNO_n20+molesN2O_n20+molesPN2O_n20+molesN2_n20+molesPN2_n20+molesNH4_n20)
plt.bar(pH_n20-.6,molesPNH3_n20,width,color='crimson',alpha=.4,hatch='/',bottom=molesNO3_n20+molesHNO3_n20+molesPHNO3_n20+molesNO2_n20+molesHNO2_n20+molesPHNO2_n20+molesNO_n20+molesPNO_n20+molesN2O_n20+molesPN2O_n20+molesN2_n20+molesPN2_n20+molesNH4_n20+molesNH3_n20)


#H2=1E-30
plt.bar(pH_n30-.4,molesNO3_n30,width,color='royalblue',alpha=.8)
plt.bar(pH_n30-.4,molesHNO3_n30,width,color='royalblue',alpha=.4,bottom=molesNO3_n30)
plt.bar(pH_n30-.4,molesPHNO3_n30,width,color='royalblue',alpha=.4,hatch='/',bottom=molesNO3_n30+molesHNO3_n30)
plt.bar(pH_n30-.4,molesNO2_n30,width,color='mediumseagreen',alpha=.8,bottom=molesNO3_n30+molesHNO3_n30+molesPHNO3_n30)
plt.bar(pH_n30-.4,molesHNO2_n30,width,color='mediumseagreen',alpha=.4,bottom=molesNO3_n30+molesHNO3_n30+molesPHNO3_n30+molesNO2_n30)
plt.bar(pH_n30-.4,molesPHNO2_n30,width,color='mediumseagreen',alpha=.4,hatch='/',bottom=molesNO3_n30+molesHNO3_n30+molesPHNO3_n30+molesNO2_n30+molesHNO2_n30)
plt.bar(pH_n30-.4,molesNO_n30,width,color='gold',alpha=.4,bottom=molesNO3_n30+molesHNO3_n30+molesPHNO3_n30+molesNO2_n30+molesHNO2_n30+molesPHNO2_n30)
plt.bar(pH_n30-.4,molesPNO_n30,width,color='gold',alpha=.4,hatch='/',bottom=molesNO3_n30+molesHNO3_n30+molesPHNO3_n30+molesNO2_n30+molesHNO2_n30+molesPHNO2_n30+molesNO_n30)
plt.bar(pH_n30-.4,molesN2O_n30,width,color='aqua',alpha=.4,bottom=molesNO3_n30+molesHNO3_n30+molesPHNO3_n30+molesNO2_n30+molesHNO2_n30+molesPHNO2_n30+molesNO_n30+molesPNO_n30)
plt.bar(pH_n30-.4,molesPN2O_n30,width,color='aqua',alpha=.4,hatch='/',bottom=molesNO3_n30+molesHNO3_n30+molesPHNO3_n30+molesNO2_n30+molesHNO2_n30+molesPHNO2_n30+molesNO_n30+molesPNO_n30+molesN2O_n30)
plt.bar(pH_n30-.4,molesN2_n30,width,color='darkviolet',alpha=.4,bottom=molesNO3_n30+molesHNO3_n30+molesPHNO3_n30+molesNO2_n30+molesHNO2_n30+molesPHNO2_n30+molesNO_n30+molesPNO_n30+molesN2O_n30+molesPN2O_n30)
plt.bar(pH_n30-.4,molesPN2_n30,width,color='darkviolet',alpha=.4,hatch='/',bottom=molesNO3_n30+molesHNO3_n30+molesPHNO3_n30+molesNO2_n30+molesHNO2_n30+molesPHNO2_n30+molesNO_n30+molesPNO_n30+molesN2O_n30+molesPN2O_n30+molesN2_n30)
plt.bar(pH_n30-.4,molesNH4_n30,width,color='crimson',alpha=.8,bottom=molesNO3_n30+molesHNO3_n30+molesPHNO3_n30+molesNO2_n30+molesHNO2_n30+molesPHNO2_n30+molesNO_n30+molesPNO_n30+molesN2O_n30+molesPN2O_n30+molesN2_n30+molesPN2_n30)
plt.bar(pH_n30-.4,molesNH3_n30,width,color='crimson',alpha=.4,bottom=molesNO3_n30+molesHNO3_n30+molesPHNO3_n30+molesNO2_n30+molesHNO2_n30+molesPHNO2_n30+molesNO_n30+molesPNO_n30+molesN2O_n30+molesPN2O_n30+molesN2_n30+molesPN2_n30+molesNH4_n30)
plt.bar(pH_n30-.4,molesPNH3_n30,width,color='crimson',alpha=.4,hatch='/',bottom=molesNO3_n30+molesHNO3_n30+molesPHNO3_n30+molesNO2_n30+molesHNO2_n30+molesPHNO2_n30+molesNO_n30+molesPNO_n30+molesN2O_n30+molesPN2O_n30+molesN2_n30+molesPN2_n30+molesNH4_n30+molesNH3_n30)



#H2=1E-40
plt.bar(pH_n40-.2,molesNO3_n40,width,color='royalblue',alpha=.8)
plt.bar(pH_n40-.2,molesHNO3_n40,width,color='royalblue',alpha=.4,bottom=molesNO3_n40)
plt.bar(pH_n40-.2,molesPHNO3_n40,width,color='royalblue',alpha=.4,hatch='/',bottom=molesNO3_n40+molesHNO3_n40)
plt.bar(pH_n40-.2,molesNO2_n40,width,color='mediumseagreen',alpha=.8,bottom=molesNO3_n40+molesHNO3_n40+molesPHNO3_n40)
plt.bar(pH_n40-.2,molesHNO2_n40,width,color='mediumseagreen',alpha=.4,bottom=molesNO3_n40+molesHNO3_n40+molesPHNO3_n40+molesNO2_n40)
plt.bar(pH_n40-.2,molesPHNO2_n40,width,color='mediumseagreen',alpha=.4,hatch='/',bottom=molesNO3_n40+molesHNO3_n40+molesPHNO3_n40+molesNO2_n40+molesHNO2_n40)
plt.bar(pH_n40-.2,molesNO_n40,width,color='gold',alpha=.4,bottom=molesNO3_n40+molesHNO3_n40+molesPHNO3_n40+molesNO2_n40+molesHNO2_n40+molesPHNO2_n40)
plt.bar(pH_n40-.2,molesPNO_n40,width,color='gold',alpha=.4,hatch='/',bottom=molesNO3_n40+molesHNO3_n40+molesPHNO3_n40+molesNO2_n40+molesHNO2_n40+molesPHNO2_n40+molesNO_n40)
plt.bar(pH_n40-.2,molesN2O_n40,width,color='aqua',alpha=.4,bottom=molesNO3_n40+molesHNO3_n40+molesPHNO3_n40+molesNO2_n40+molesHNO2_n40+molesPHNO2_n40+molesNO_n40+molesPNO_n40)

plt.bar(pH_n40-.2,molesPN2O_n40,width,color='aqua',alpha=.4,hatch='/',bottom=molesNO3_n40+molesHNO3_n40+molesPHNO3_n40+molesNO2_n40+molesHNO2_n40+molesPHNO2_n40+molesNO_n40+molesPNO_n40+molesN2O_n40)
plt.bar(pH_n40-.2,molesN2_n40,width,color='darkviolet',alpha=.4,bottom=molesNO3_n40+molesHNO3_n40+molesPHNO3_n40+molesNO2_n40+molesHNO2_n40+molesPHNO2_n40+molesNO_n40+molesPNO_n40+molesN2O_n40+molesPN2O_n40)
plt.bar(pH_n40-.2,molesPN2_n40,width,color='darkviolet',alpha=.4,hatch='/',bottom=molesNO3_n40+molesHNO3_n40+molesPHNO3_n40+molesNO2_n40+molesHNO2_n40+molesPHNO2_n40+molesNO_n40+molesPNO_n40+molesN2O_n40+molesPN2O_n40+molesN2_n40)
plt.bar(pH_n40-.2,molesNH4_n40,width,color='crimson',alpha=.8,bottom=molesNO3_n40+molesHNO3_n40+molesPHNO3_n40+molesNO2_n40+molesHNO2_n40+molesPHNO2_n40+molesNO_n40+molesPNO_n40+molesN2O_n40+molesPN2O_n40+molesN2_n40+molesPN2_n40)
plt.bar(pH_n40-.2,molesNH3_n40,width,color='crimson',alpha=.4,bottom=molesNO3_n40+molesHNO3_n40+molesPHNO3_n40+molesNO2_n40+molesHNO2_n40+molesPHNO2_n40+molesNO_n40+molesPNO_n40+molesN2O_n40+molesPN2O_n40+molesN2_n40+molesPN2_n40+molesNH4_n40)
plt.bar(pH_n40-.2,molesPNH3_n40,width,color='crimson',alpha=.4,hatch='/',bottom=molesNO3_n40+molesHNO3_n40+molesPHNO3_n40+molesNO2_n40+molesHNO2_n40+molesPHNO2_n40+molesNO_n40+molesPNO_n40+molesN2O_n40+molesPN2O_n40+molesN2_n40+molesPN2_n40+molesNH4_n40+molesNH3_n40)

#H2=1E-50
plt.bar(pH_n50,molesNO3_n50,width,color='royalblue',alpha=.8)
plt.bar(pH_n50,molesHNO3_n50,width,color='royalblue',alpha=.4,bottom=molesNO3_n50)
plt.bar(pH_n50,molesPHNO3_n50,width,color='royalblue',alpha=.4,hatch='/',bottom=molesNO3_n50+molesHNO3_n50)
plt.bar(pH_n50,molesNO2_n50,width,color='mediumseagreen',alpha=.8,bottom=molesNO3_n50+molesHNO3_n50+molesPHNO3_n50)
plt.bar(pH_n50,molesHNO2_n50,width,color='mediumseagreen',alpha=.4,bottom=molesNO3_n50+molesHNO3_n50+molesPHNO3_n50+molesNO2_n50)
plt.bar(pH_n50,molesPHNO2_n50,width,color='mediumseagreen',alpha=.4,hatch='/',bottom=molesNO3_n50+molesHNO3_n50+molesPHNO3_n50+molesNO2_n50+molesHNO2_n50)
plt.bar(pH_n50,molesNO_n50,width,color='gold',alpha=.4,bottom=molesNO3_n50+molesHNO3_n50+molesPHNO3_n50+molesNO2_n50+molesHNO2_n50+molesPHNO2_n50)
plt.bar(pH_n50,molesPNO_n50,width,color='gold',alpha=.4,hatch='/',bottom=molesNO3_n50+molesHNO3_n50+molesPHNO3_n50+molesNO2_n50+molesHNO2_n50+molesPHNO2_n50+molesNO_n50)
plt.bar(pH_n50,molesN2O_n50,width,color='aqua',alpha=.4,bottom=molesNO3_n50+molesHNO3_n50+molesPHNO3_n50+molesNO2_n50+molesHNO2_n50+molesPHNO2_n50+molesNO_n50+molesPNO_n50)

plt.bar(pH_n50,molesPN2O_n50,width,color='aqua',alpha=.4,hatch='/',bottom=molesNO3_n50+molesHNO3_n50+molesPHNO3_n40+molesNO2_n50+molesHNO2_n50+molesPHNO2_n50+molesNO_n50+molesPNO_n50+molesN2O_n50)
plt.bar(pH_n50,molesN2_n50,width,color='darkviolet',alpha=.4,bottom=molesNO3_n50+molesHNO3_n40+molesPHNO3_n50+molesNO2_n50+molesHNO2_n50+molesPHNO2_n50+molesNO_n50+molesPNO_n50+molesN2O_n50+molesPN2O_n50)
plt.bar(pH_n50,molesPN2_n50,width,color='darkviolet',alpha=.4,hatch='/',bottom=molesNO3_n50+molesHNO3_n50+molesPHNO3_n50+molesNO2_n50+molesHNO2_n50+molesPHNO2_n50+molesNO_n50+molesPNO_n50+molesN2O_n50+molesPN2O_n50+molesN2_n50)
plt.bar(pH_n50,molesNH4_n50,width,color='crimson',alpha=.8,bottom=molesNO3_n50+molesHNO3_n50+molesPHNO3_n50+molesNO2_n50+molesHNO2_n50+molesPHNO2_n50+molesNO_n50+molesPNO_n50+molesN2O_n50+molesPN2O_n50+molesN2_n50+molesPN2_n50)
plt.bar(pH_n50,molesNH3_n50,width,color='crimson',alpha=.4,bottom=molesNO3_n50+molesHNO3_n50+molesPHNO3_n50+molesNO2_n50+molesHNO2_n50+molesPHNO2_n50+molesNO_n50+molesPNO_n50+molesN2O_n50+molesPN2O_n50+molesN2_n50+molesPN2_n50+molesNH4_n50)
plt.bar(pH_n50,molesPNH3_n50,width,color='crimson',alpha=.4,hatch='/',bottom=molesNO3_n50+molesHNO3_n50+molesPHNO3_n50+molesNO2_n50+molesHNO2_n50+molesPHNO2_n50+molesNO_n50+molesPNO_n50+molesN2O_n50+molesPN2O_n50+molesN2_n50+molesPN2_n50+molesNH4_n50+molesNH3_n50)
...
plt.bar(pH_n60+.2,molesPHNO2_n60,width,color='mediumseagreen',alpha=.4,hatch='/',bottom=molesNO3_60+molesHNO3_n60+molesPHNO3_n60+molesNO2_n60+molesHNO2_n60)
...
#H2=1E-70
plt.bar(pH_n70+.4,molesNO3_n70,width,color='royalblue',alpha=.8)
plt.bar(pH_n70+.4,molesHNO3_n70,width,color='royalblue',alpha=.4,bottom=molesNO3_n70)
plt.bar(pH_n70+.4,molesPHNO3_n70,width,color='royalblue',alpha=.4,hatch='/',bottom=molesNO3_n70+molesHNO3_n70)
plt.bar(pH_n70+.4,molesNO2_n70,width,color='mediumseagreen',alpha=.8,bottom=molesNO3_n70+molesHNO3_n70+molesPHNO3_n70)
plt.bar(pH_n70+.4,molesHNO2_n70,width,color='mediumseagreen',alpha=.4,bottom=molesNO3_n70+molesHNO3_n70+molesPHNO3_n70+molesNO2_n70)
plt.bar(pH_n70+.4,molesPHNO2_n70,width,color='mediumseagreen',alpha=.4,hatch='/',bottom=molesNO3_70+molesHNO3_n70+molesPHNO3_n70+molesNO2_n70+molesHNO2_n70)
plt.bar(pH_n70+.4,molesNO_n70,width,color='gold',alpha=.4,bottom=molesNO3_n70+molesHNO3_n70+molesPHNO3_n70+molesNO2_n70+molesHNO2_n70+molesPHNO2_n70)
plt.bar(pH_n70+.4,molesPNO_n70,width,color='gold',alpha=.4,hatch='/',bottom=molesNO3_n70+molesHNO3_n70+molesPHNO3_n70+molesNO2_n70+molesHNO2_n70+molesPHNO2_n70+molesNO_n70)
plt.bar(pH_n70+.4,molesN2O_n70,width,color='aqua',alpha=.4,bottom=molesNO3_n70+molesHNO3_n70+molesPHNO3_n70+molesNO2_n70+molesHNO2_n70+molesPHNO2_n70+molesNO_n70+molesPNO_n70)

plt.bar(pH_n70+.4,molesPN2O_n70,width,color='aqua',alpha=.4,hatch='/',bottom=molesNO3_n70+molesHNO3_n70+molesPHNO3_n70+molesNO2_n70+molesHNO2_n70+molesPHNO2_n70+molesNO_n70+molesPNO_n70+molesN2O_n70)
plt.bar(pH_n70+.4,molesN2_n70,width,color='darkviolet',alpha=.4,bottom=molesNO3_n70+molesHNO3_n70+molesPHNO3_n70+molesNO2_n70+molesHNO2_n70+molesPHNO2_n70+molesNO_n70+molesPNO_n70+molesN2O_n70+molesPN2O_n70)
plt.bar(pH_n70+.4,molesPN2_n70,width,color='darkviolet',alpha=.4,hatch='/',bottom=molesNO3_n70+molesHNO3_n70+molesPHNO3_n70+molesNO2_n70+molesHNO2_n70+molesPHNO2_n70+molesNO_n70+molesPNO_n70+molesN2O_n70+molesPN2O_n70+molesN2_n70)
plt.bar(pH_n70+.4,molesNH4_n70,width,color='crimson',alpha=.8,bottom=molesNO3_n70+molesHNO3_n70+molesPHNO3_n70+molesNO2_n70+molesHNO2_n70+molesPHNO2_n70+molesNO_n70+molesPNO_n70+molesN2O_n70+molesPN2O_n70+molesN2_n70+molesPN2_n70)
plt.bar(pH_n70+.4,molesNH3_n70,width,color='crimson',alpha=.4,bottom=molesNO3_n70+molesHNO3_n70+molesPHNO3_n70+molesNO2_n70+molesHNO2_n70+molesPHNO2_n70+molesNO_n70+molesPNO_n70+molesN2O_n70+molesPN2O_n70+molesN2_n70+molesPN2_n70+molesNH4_n70)
plt.bar(pH_n70+.4,molesPNH3_n70,width,color='crimson',alpha=.4,hatch='/',bottom=molesNO3_n70+molesHNO3_n70+molesPHNO3_n70+molesNO2_n70+molesHNO2_n70+molesPHNO2_n70+molesNO_n70+molesPNO_n70+molesN2O_n70+molesPN2O_n70+molesN2_n70+molesPN2_n70+molesNH4_n70+molesNH3_n70)


#H2=1E-80
plt.bar(pH_n80+.6,molesNO3_n80,width,color='royalblue',alpha=.8)
plt.bar(pH_n80+.6,molesHNO3_n80,width,color='royalblue',alpha=.4,bottom=molesNO3_n80)
plt.bar(pH_n80+.6,molesPHNO3_n80,width,color='royalblue',alpha=.4,hatch='/',bottom=molesNO3_n80+molesHNO3_n80)
plt.bar(pH_n80+.6,molesNO2_n80,width,color='mediumseagreen',alpha=.8,bottom=molesNO3_n80+molesHNO3_n80+molesPHNO3_n80)
plt.bar(pH_n80+.6,molesHNO2_n80,width,color='mediumseagreen',alpha=.4,bottom=molesNO3_n80+molesHNO3_n80+molesPHNO3_n80+molesNO2_n80)
plt.bar(pH_n80+.6,molesPHNO2_n80,width,color='mediumseagreen',alpha=.4,hatch='/',bottom=molesNO3_80+molesHNO3_n80+molesPHNO3_n80+molesNO2_n80+molesHNO2_n80)
plt.bar(pH_n80+.6,molesNO_n80,width,color='gold',alpha=.4,bottom=molesNO3_n80+molesHNO3_n80+molesPHNO3_n80+molesNO2_n80+molesHNO2_n80+molesPHNO2_n80)
plt.bar(pH_n80+.6,molesPNO_n80,width,color='gold',alpha=.4,hatch='/',bottom=molesNO3_n80+molesHNO3_n80+molesPHNO3_n80+molesNO2_n80+molesHNO2_n80+molesPHNO2_n80+molesNO_n80)
plt.bar(pH_n80+.6,molesN2O_n80,width,color='aqua',alpha=.4,bottom=molesNO3_n80+molesHNO3_n80+molesPHNO3_n80+molesNO2_n80+molesHNO2_n80+molesPHNO2_n80+molesNO_n80+molesPNO_n80)

plt.bar(pH_n80+.6,molesPN2O_n80,width,color='aqua',alpha=.4,hatch='/',bottom=molesNO3_n80+molesHNO3_n80+molesPHNO3_n80+molesNO2_n80+molesHNO2_n80+molesPHNO2_n80+molesNO_n80+molesPNO_n80+molesN2O_n80)
plt.bar(pH_n80+.6,molesN2_n80,width,color='darkviolet',alpha=.4,bottom=molesNO3_n80+molesHNO3_n80+molesPHNO3_n80+molesNO2_n80+molesHNO2_n80+molesPHNO2_n80+molesNO_n80+molesPNO_n80+molesN2O_n80+molesPN2O_n80)
plt.bar(pH_n80+.6,molesPN2_n80,width,color='darkviolet',alpha=.4,hatch='/',bottom=molesNO3_n80+molesHNO3_n80+molesPHNO3_n80+molesNO2_n80+molesHNO2_n80+molesPHNO2_n80+molesNO_n80+molesPNO_n80+molesN2O_n80+molesPN2O_n80+molesN2_n80)
plt.bar(pH_n80+.6,molesNH4_n80,width,color='crimson',alpha=.8,bottom=molesNO3_n80+molesHNO3_n80+molesPHNO3_n80+molesNO2_n80+molesHNO2_n80+molesPHNO2_n80+molesNO_n80+molesPNO_n80+molesN2O_n80+molesPN2O_n80+molesN2_n80+molesPN2_n80)
plt.bar(pH_n80+.6,molesNH3_n80,width,color='crimson',alpha=.4,bottom=molesNO3_n80+molesHNO3_n80+molesPHNO3_n80+molesNO2_n80+molesHNO2_n80+molesPHNO2_n80+molesNO_n80+molesPNO_n80+molesN2O_n80+molesPN2O_n80+molesN2_n80+molesPN2_n80+molesNH4_n80)
plt.bar(pH_n80+.6,molesPNH3_n80,width,color='crimson',alpha=.4,hatch='/',bottom=molesNO3_n80+molesHNO3_n80+molesPHNO3_n80+molesNO2_n80+molesHNO2_n80+molesPHNO2_n80+molesNO_n80+molesPNO_n80+molesN2O_n80+molesPN2O_n80+molesN2_n80+molesPN2_n80+molesNH4_n80+molesNH3_n80)
